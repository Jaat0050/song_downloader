...
class _SongDownloaderAppState extends State<SongDownloaderApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: _initialized ? MainShell(apiService: _apiService, onUrlUpdated: () => setState(() {})) : const Scaffold(body: Center(child: CircularProgressIndicator())),
    );
  }
}
...
class MainShell extends StatefulWidget {
  ...
  const MainShell({super.key, required this.apiService, required this.onUrlUpdated});
...
class _MainShellState extends State<MainShell> {
  ...
  @override
  Widget build(BuildContext context) {
    final pages = [HomeScreen(apiService: widget.apiService), const LibraryScreen(), SettingsScreen(apiService: widget.apiService, onUrlUpdated: widget.onUrlUpdated)];
