...
class ServerHealth {
  ...
  const ServerHealth({
    required this.healthy, required this.status, required this.server,
    required this.host, required this.port, required this.uptimeSeconds,
    required this.startedAt, required this.pythonVersion,
    required this.ytDlpVersion, required this.audioFormat, required this.ffmpeg,
    required this.storageBytes, required this.diskFreeBytes,
    required this.diskTotalBytes, required this.storageReady,
    required this.jobs, required this.workerCount, required this.workerStatus,
  });
...
class DownloaderApiService {
  ...
  String _extractDioError(DioException e) {
    ...
    if (e.response?.statusCode == 429) return 'Too many downloads are active. Please wait for one to finish.';
