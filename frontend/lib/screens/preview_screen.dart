...
class _PreviewScreenState extends State<PreviewScreen> {
  ...
  Future<void> _startDownload() async {
    ...
    try {
      final jobId = await widget.apiService.startDownload(widget.songInfo.webpageUrl);
      if (!mounted) return;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Row(
                      children: [
                        Icon(Icons.high_quality_rounded, color: Color(0xFF8B5CF6)),
                        SizedBox(width: 12),
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              SizedBox(height: 3),
                              Text(
                                'Original source stream • Converted safely on backend',
                  ...
                  FilledButton.icon(
                    ...
                    label: Text(_starting ? 'Starting download…' : 'Download Audio'),
